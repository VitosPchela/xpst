...
{
   filename    = "~/data/sound/lgtstep_mono_01";
...
{
   filename    = "~/data/sound/hvystep_ mono_01";
   description = AudioClose3d;
   preload = true;
};
...
{
   filename    = "~/data/sound/metalstep_mono_01";
   description = AudioClose3d;
   preload = true;
};
...
{
   filename    = "~/data/sound/snowstep_mono_01";
   description = AudioClosest3d;
   preload = true;
};
...
{
   filename    = "~/data/sound/waterstep_mono_01";
   description = AudioClose3d;
   preload = true;
};
