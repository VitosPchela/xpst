...
public class NumSum extends Type {
	...
	public boolean check(HashMap<String, GoalNode> gns,String value)
	{
		...
		myval = getNumSum(t1,t2,t3,t4);
		return myval == si;
	}
	
	public double getNumSum(double n1,double d1,double n2,double d2)
	{
		double gcd = gcd(d1,d2);
		double multiplier1 = d2/gcd;
		double newNumerator1 = n1*multiplier1;
		double multiplier2 = d1/gcd;
		double newNumerator2 = n2*multiplier2;
