...
public class MapperTest
{
	...
	private final String rootdir = "test/org/clearsighted/tutorbase/emscript/";
	private void testMap(String fname) throws Exception
	{
		...
		EMScriptEventMapper emem = new EMScriptEventMapper(rootdir + "testscripts/" + fname + ".em", "tutor");
	...
	@Test public void testMap0() throws Exception
	{
		testMap("map0");
	}

	@Test public void testMap1() throws Exception
	{
		testMap("map1");
	}

	@Test public void testMapConcat0() throws Exception
	{
		testMap("mapconcat0");
	}

	@Test public void testMapPrio0() throws Exception
	{
		testMap("mapprio0");
	}

	@Test public void testMapFocusedOnly0() throws Exception
	{
		testMap("mapfocusedonly0");
	}

	@Test public void testMapUncomp0() throws Exception
	{
		testMap("mapuncomp0");
	}

	@Test public void testMapUntil0() throws Exception
	{
		testMap("mapuntil0");
	}

	@Test public void testMapUntil1() throws Exception
	{
		testMap("mapuntil1");
	}
}
