...
public class RenameAction extends MappingAction
{
	public String AppNodeName = null;

	public RenameAction(RuleOptions options, Mapping mymapping, String goalnodename)
	{
	...
	public void map(boolean toapp, DorminMessage in, List<DorminMessage> ret, String tutorname)
	{
		...
		if (toapp)
			msg.Address = new DorminAddress(AppNodeName);
		else
